...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $word1 = $_POST['sy_word'];
    $image1 = $_FILES['word_image1']['name'];
    $image_tmp1 = $_FILES['word_image1']['tmp_name'];
    $folder1 = "upload_img";
    ...
    $sql1 = "SELECT id FROM oed_words WHERE word = '$search_word' LIMIT 1";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="container">
        <div class="row">
          <h2 style="text-align: center; margin-top: 3%;">ADD SYNONYM</h2>
            <!-------------->
         <div class="col-md-4" id="hide_add_syno" style=" margin: 0 auto; margin-top: 4%; ">
                <!-- synonym & antonym -->
                <div class="card p-3" id="card_color"  style="width: 23rem; margin: 0 auto; margin-bottom: 4%;">
                    <form action="synonym.php" enctype="multipart/form-data" method="POST">
                        <div class="input-group ">
                            <div style="margin: 2%;">
                            <label for="word">Word:</label>
                                <input type="text" name="sy_word" class="form-control" required>
                            </div>
                            <div style="margin: 2%;">
                            <label for="image">Image:</label>
                                <input type="file" name="word_image1" class="form-control" required>
                            </div>
                            <div style="margin-top: 3%; margin-right: 70px; margin-left: 2%;">
                                <button type="submit" name="sy_btn" class="input-group-text btn btn-primary"> Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
