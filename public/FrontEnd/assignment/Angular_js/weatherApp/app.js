...
angular
  ...
  .controller("weatherController", function ($scope, $http) {
    ...
    var weatherUrlEnd =
      "&lang=lt&units=metric&appid=48507c7efbe2a4ca1b59a199ea479b46";
    ...
    $scope.getGeolocation = function () {
      $http({
        ...
        function (data) {
          ...
          $scope.latData =
            data.data.results[0].annotations.DMS.lat.match(/^\d+/);
          $scope.lonData =
            data.data.results[0].annotations.DMS.lng.match(/^\d+/);
    ...
    $scope.findCity = function () {
      ...
      if ($scope.writtenCity !== "") {
        ...
        $scope.geocodingUrl =
          geolocationUrlStart + $scope.selectedCity + geolocationUrlEnd;
    ...
    $scope.findAutomatic = function () {
      ...
      $http({
        ...
        function error(data) {
          $scope.cityName = "Coordinates not found";
        }
      );
    };
