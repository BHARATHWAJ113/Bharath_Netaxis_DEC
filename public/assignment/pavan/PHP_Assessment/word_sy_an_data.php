      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <ul class="navbar-nav">
          <!-- <form action="" method="post">
            <button class="btn btn-danger" name="logout_admin" style="margin-right: 3px; margin: 4px;">Logout</button>
          </form> -->
        </ul>
      </div>
    </div>
...
<div class="container">
    <div class='alert alert-success' style="width: 20rem; margin: 0 auto; margin-top: 5%;"><h5><b>Your Word has been Added successfully Please wait until <br>admin approve your Word</b></h5></div>
</div>
