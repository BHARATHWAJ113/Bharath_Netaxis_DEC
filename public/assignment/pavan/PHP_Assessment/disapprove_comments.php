    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="./comments.php" style="color: #eb4dc6;">Comment</a>
          </li>
        </ul>
        <ul class="navbar-nav">
...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "UPDATE oed_comments SET is_approved = 0 WHERE id=$id";
    $result = $conn->query($sql);
  if($result == true){
    echo "<div class='alert alert-warning' style='width: 23rem; margin: 0 auto; margin-top: 6%;'>This comment has been disapproved</div>";
  }else{
