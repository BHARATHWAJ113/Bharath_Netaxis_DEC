...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "UPDATE oed_words SET is_approved = 0 WHERE id=$id";
    $result = $conn->query($sql);
  if($result == true){
    echo "<div class='alert alert-warning' style='width: 23rem; margin: 0 auto; margin-top: 6%;'>This Word has been disapproved</div>";
  }else{
