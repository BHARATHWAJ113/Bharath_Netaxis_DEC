<nav class="navbar navbar-expand-md navbar-light bg-transprant">
    ...
    <div class="sidebar collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="list-group list-group-flush shadow mb-5" style="border-radius:25px;">
            ...
            <li class="list-group-item nav-item sildehover border-0">
                <a href="{{ route('chating') }}" style="text-decoration: none; color: black;">
                    <button type="button" class="btnn h4">
                        <i class="fa-solid fa-comments px-1 " style="color: #1874ec;"></i>Chat</b>
                    </button>
                </a>
            </li>
            <li class="list-group-item nav-item sildehover border-0">
