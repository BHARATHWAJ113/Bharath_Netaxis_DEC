...
/*------------------------------------------------------------------Project assesment & assignment Start------------------------------------------------------------------ */


Route::get('/assesment', function () {
    return view('assesment.index.php');
});
Route::get('/assignment', function () {
    return view('assignment.index.php');
});


/*------------------------------------------------------------------Project assesment & assignment End------------------------------------------------------------------ */
...
/*------------------------------------------------------------------Project Chat start------------------------------------------------------------------ */
Route::get('/chats', 'MessagesController@index')->name('chating');
Route::post('/send-chat', 'MessagesController@sendMessage')->name('send_chat');
Route::get('/messages/{to_user}', 'MessagesController@getMessageHistory')->name('messages');
Route::get('/chatexplore', 'MessagesController')->name('chats');
